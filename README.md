# 🎞 MAVEN Movie Rental – SQL Analysis Project
...
## 📌 Overview
  ...
  This project contains SQL scripts for the Maven Movie Rental Database, a case study dataset inspired by real-world movie rental businesses.
